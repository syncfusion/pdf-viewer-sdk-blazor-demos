...
namespace BlazorDemos
{
    ...
    {
        private static readonly string[] CustomToolBarNotification = new string[] { "The custom toolbar demo has been updated with a new UI and additional functionalities, adding various annotations such as highlights, free text, shapes, stamps, drawings, and handwritten signatures. Users can also edit these annotations within the document." };
        private static readonly string[] AccessiblePdfReadingNotification = new string[] { "This accessible PDF reading example demonstrates how to enable screen-reader support and read-aloud functionality in a PDF Viewer. It provides intuitive navigation with next and previous page controls, ensuring an inclusive reading experience for users with visual impairments." };
        private static readonly string[] OrganizePagesNotification = new string[] { "This page organization example demonstrates how to insert, delete, rearrange, copy, import, undo, redo, and rotate pages in a PDF document. It also allows selecting all pages for collective adjustments and saving or downloading the edited file instantly." };
        public List<Sample> PDFViewer { get; set; } = new List<Sample>{
             ...
             new Sample
            {
                ...
                NotificationDescription = OrganizePagesNotification
            },
             new Sample
            {
                Name = "Redaction",
            ...
            new Sample
            {
                ...
                NotificationDescription = CustomToolBarNotification,
                SourceFiles = new List<SourceFileInfo>()
                {
                    new SourceFileInfo
                    {
            ...
            new Sample
            {
                ...
                Category = "Toolbar",
                Directory = "Viewer/PdfViewer",
                Url = "primary-toolbar-customization",
            ...
            new Sample
            {
                ...
                Category = "Annotation",
                Directory = "Viewer/PdfViewer",
                Url = "programmatical-annotations",
            ...
            new Sample
            {
                ...
                NotificationDescription = AccessiblePdfReadingNotification,
                SourceFiles = new List<SourceFileInfo>()
                {
                    new SourceFileInfo
                    {
            ...
            new Sample
            {
                ...
                Category = "Signature",
                Directory = "Viewer/PdfViewer",
                Url = "invisible-digital-signature",
