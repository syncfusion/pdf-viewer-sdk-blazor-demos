...
namespace BlazorDemos
{
    ...
    {
        internal List<SampleListType>? SourceData { get; set; }
    ...
    public class SampleList
    {
        ...
        [JsonConverter(typeof(JsonStringEnumConverter))]
        public SampleType Type { get; set; }
        internal List<Sample>? Samples { get; set; } = new List<Sample>();
        ...
        internal string[]? NotificationDescription { get; set; }
    }
    ...
    public class Sample
    {
        ...
        internal List<SourceFileInfo> SourceFiles { get; set; } = new List<SourceFileInfo>();
        [JsonConverter(typeof(JsonStringEnumConverter))]
        public SampleType Type { get; set; }
        internal string[]? NotificationDescription { get; set; }
    ...
    internal class ControlSampleResult
    {
        internal SampleList? Control { get; set; }
        internal Sample? Sample { get; set; }
    }
    ...
    #endif
#else
            "https://cdn.syncfusion.com/blazor/documentprocessing-sb/pdfviewer/styles/32.2.3/common/fonts/open-sans-700.woff2",            
            "https://cdn.syncfusion.com/blazor/documentprocessing-sb/pdfviewer/styles/32.2.3/common/fonts/open-sans-regular.woff2"
#endif
#endif
        };
    }
