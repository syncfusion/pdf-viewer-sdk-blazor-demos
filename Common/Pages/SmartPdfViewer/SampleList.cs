...
namespace BlazorDemos
{
    ...
    {
        private static readonly string[] NotificationDescriptionItem = new string[] { " This demo showcases the Smart PDF Viewer AI feature." };
        ...
        public List<Sample> SmartPdfViewer { get; set; } = new List<Sample>{
            ...
            new Sample
            {
                ...
                NotificationDescription = NotificationDescriptionItem
            },
             new Sample
            {
                Name = "Redaction",
