...
namespace BlazorDemos.Pages.Viewer
{
    public partial class ProgrammaticalAnnotationBase
    {
        ...
        internal sealed class AnnotationBase
        {
            ...
            internal bool IsAllowedInterActionsNone { get; set; }
            internal bool IsAllowedInterActionsSelect { get; set; }
            internal bool IsAllowedInterActionsMove { get; set; }
            internal bool IsAllowedInterActionsDelete { get; set; }
            internal bool IsAllowedInterActionsPropertyChange { get; set; }
            internal bool IsAllowedInterActionsResize { get; set; }
            ...
            internal string ModifiedDate { get; set; } = DateTime.Now.ToString(CultureInfo.CurrentCulture);
            internal string ReplyModifiedDate { get; set; } = DateTime.Now.ToString(CultureInfo.CurrentCulture);
            ...
            internal int LeaderLength { get; set; }
            ...
            internal bool AnnotationSelected { get; set; }
            ...
            internal bool EditReply { get; set; }
            ...
            internal int VertexPointCount { get; set; }
            internal string VertexPointString { get; set; } = "";
            internal bool IsInputChange { get; set; }
        ...
        internal sealed class AnnotationsFields
        {
